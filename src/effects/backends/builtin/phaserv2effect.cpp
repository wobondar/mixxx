...
// static
QString PhaserV2Effect::getId() {
    return "org.mixxx.effects.phaserv2";
}

// static
EffectManifestPointer PhaserV2Effect::getManifest() {
    EffectManifestPointer pManifest(new EffectManifest());
    pManifest->setId(getId());
    pManifest->setName(QObject::tr("Phaser V2"));
    pManifest->setShortName(QObject::tr("PhaserV2"));
    ...
    period->setDescription(QObject::tr(
            ...
            "1/4 - 16 beats rounded to 1/2 beat if tempo is detected\n"
            "1/4 - 16 seconds if no tempo is detected"));
    ...
    // V2: cap raised 4 -> 16 beats.
    period->setRange(0.0, 1.0, 16.0);
...
void PhaserV2Effect::loadEngineEffectParameters(
...
void PhaserV2Effect::processChannel(
        PhaserV2GroupState* pState,
